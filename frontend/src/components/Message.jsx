      ...
      <div className="w-3/4 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 mb-4 flex flex-col gap-2">
          {messages.map((msg, index) => (
            ...
            >
              <div
                className={`p-2 rounded-lg inline-block max-w-xs ${msg.senderId === userId ? 'bg-blue-500 text-white' : 'bg-gray-300 text-black'}`}
              >
                {msg.message}
              </div>
            </div>
        ...
        {selectedUser && (
          <div className="p-4 flex items-center border-t sticky bottom-0 bg-white">
            <input
              type="text"
              value={newMessage}
